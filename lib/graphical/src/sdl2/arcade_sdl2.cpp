...
Sdl2::Sdl2() : mWindow(nullptr), mWindowRender(nullptr), mFont(nullptr)
{
    mName = "sdl2";
    mEvents = {
        {SDLK_UP, Event::K_UP}, {SDLK_DOWN, Event::K_DOWN}, {SDLK_LEFT, Event::K_LEFT},
        {SDLK_RIGHT, Event::K_RIGHT}, {SDLK_ESCAPE, Event::K_ESCAPE}, {SDLK_RETURN, Event::K_RETURN},
        {SDLK_SPACE, Event::K_SPACE}, {SDLK_F1, Event::K_F1}, {SDLK_a, Event::KEY_A},
        {SDLK_b, Event::KEY_B}, {SDLK_c, Event::KEY_C}, {SDLK_d, Event::KEY_D},
        {SDLK_e, Event::KEY_E}, {SDLK_f, Event::KEY_F}, {SDLK_g, Event::KEY_G},
        {SDLK_h, Event::KEY_H}, {SDLK_i, Event::KEY_I}, {SDLK_j, Event::KEY_J},
        {SDLK_k, Event::KEY_K}, {SDLK_l, Event::KEY_L}, {SDLK_m, Event::KEY_M},
        {SDLK_n, Event::KEY_N}, {SDLK_o, Event::KEY_O}, {SDLK_p, Event::KEY_P},
        {SDLK_q, Event::KEY_Q}, {SDLK_r, Event::KEY_R}, {SDLK_s, Event::KEY_S},
        {SDLK_t, Event::NEXT_LIB}, {SDLK_u, Event::KEY_U}, {SDLK_v, Event::KEY_V},
        {SDLK_w, Event::KEY_W}, {SDLK_x, Event::KEY_X}, {SDLK_y, Event::NEXT_GAME},
        {SDLK_z, Event::KEY_Z}, {SDLK_1, Event::KEY_1}, {SDLK_2, Event::KEY_2},
        {SDLK_3, Event::KEY_3}, {SDLK_4, Event::KEY_4}, {SDLK_5, Event::KEY_5},
        {SDLK_6, Event::KEY_6}, {SDLK_7, Event::KEY_7}, {SDLK_8, Event::KEY_8},
        {SDLK_9, Event::KEY_9}, {SDLK_0, Event::KEY_0}
    };
}
