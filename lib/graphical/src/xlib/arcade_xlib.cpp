...
Xlib::Xlib()
{
    mName = "xlib";
    mEvents = {
        {XK_Up, Event::K_UP}, {XK_Down, Event::K_DOWN}, {XK_Left, Event::K_LEFT},
        {XK_Right, Event::K_RIGHT}, {XK_t, Event::NEXT_LIB}, {XK_y, Event::NEXT_GAME},
        {XK_Escape, Event::K_ESCAPE}, {XK_Return, Event::K_RETURN}, {XK_space, Event::K_SPACE},
        {XK_F1, Event::K_F1}, {XK_a, Event::KEY_A}, {XK_b, Event::KEY_B},
        {XK_c, Event::KEY_C}, {XK_d, Event::KEY_D}, {XK_e, Event::KEY_E},
        {XK_f, Event::KEY_F}, {XK_g, Event::KEY_G}, {XK_h, Event::KEY_H},
        {XK_i, Event::KEY_I}, {XK_j, Event::KEY_J}, {XK_k, Event::KEY_K},
        {XK_l, Event::KEY_L}, {XK_m, Event::KEY_M}, {XK_n, Event::KEY_N},
        {XK_o, Event::KEY_O}, {XK_p, Event::KEY_P}, {XK_q, Event::KEY_Q},
        {XK_r, Event::KEY_R}, {XK_s, Event::KEY_S}, {XK_u, Event::KEY_U},
        {XK_v, Event::KEY_V}, {XK_w, Event::KEY_W}, {XK_x, Event::KEY_X},
        {XK_z, Event::KEY_Z}, {XK_1, Event::KEY_1}, {XK_2, Event::KEY_2},
        {XK_3, Event::KEY_3}, {XK_4, Event::KEY_4}, {XK_5, Event::KEY_5},
        {XK_6, Event::KEY_6}, {XK_7, Event::KEY_7}, {XK_8, Event::KEY_8},
        {XK_9, Event::KEY_9}, {XK_0, Event::KEY_0}
    };
}
