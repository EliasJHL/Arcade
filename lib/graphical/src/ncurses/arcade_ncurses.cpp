...
Ncurses::Ncurses()
{
    mName = "ncurses";
    mEvents = {
        {'t', Event::NEXT_LIB}, {KEY_UP, Event::K_UP}, {KEY_DOWN, Event::K_DOWN},
        {KEY_LEFT, Event::K_LEFT}, {KEY_RIGHT, Event::K_RIGHT}, {KEY_F(1), Event::K_F1},
        {'y', Event::NEXT_GAME}, {'Y', Event::NEXT_GAME}, {'a', Event::KEY_A},
        {'b', Event::KEY_B}, {'c', Event::KEY_C}, {'d', Event::KEY_D},
        {'e', Event::KEY_E}, {'f', Event::KEY_F}, {'g', Event::KEY_G},
        {'h', Event::KEY_H}, {'i', Event::KEY_I}, {'j', Event::KEY_J},
        {'k', Event::KEY_K}, {'l', Event::KEY_L}, {'m', Event::KEY_M},
        {'n', Event::KEY_N}, {'o', Event::KEY_O}, {'p', Event::KEY_P},
        {'q', Event::KEY_Q}, {'r', Event::KEY_R}, {'s', Event::KEY_S},
        {'u', Event::KEY_U}, {'v', Event::KEY_V}, {'w', Event::KEY_W},
        {'x', Event::KEY_X}, {'z', Event::KEY_Z}, {'1', Event::KEY_1},
        {'2', Event::KEY_2}, {'3', Event::KEY_3}, {'4', Event::KEY_4},
        {'5', Event::KEY_5}, {'6', Event::KEY_6}, {'7', Event::KEY_7},
        {'8', Event::KEY_8}, {'9', Event::KEY_9}, {'0', Event::KEY_0}
    };
}
